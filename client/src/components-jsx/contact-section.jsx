              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="bg-gray-800 w-full p-3 rounded-lg border border-transparent focus:border-white focus:outline-none transition duration-300 resize-none"
                    required
                  ></textarea>
                  <ValidationError 
                    prefix="Message" 
                ...
                <button 
                  ...
                  className="w-full bg-white text-black py-3 rounded-lg font-semibold hover:bg-gray-200 transition duration-300 disabled:opacity-50"
                >

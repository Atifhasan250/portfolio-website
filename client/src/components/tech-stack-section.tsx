      ...
      <div className="container mx-auto max-w-6xl">
        <div className="section-card-no-hover">
          ...
          <div className="flex justify-center mb-12">
            <div className="grid w-full max-w-md grid-cols-2 gap-1.5 rounded-2xl p-1.5 sm:flex sm:max-w-fit sm:justify-center sm:rounded-full" style={{ backgroundColor: 'var(--color-accent-bg)' }}>
